...
class FleetManager(Node):
    ...
    def __init__(self, config, nav_path):
        ...
        @app.get('/open-rmf/fyp_fm/status/', response_model=Response)
        ...
        @app.post('/open-rmf/fyp_fm/navigate/', response_model=Response)
        ...
        @app.get('/open-rmf/fyp_fm/stop_robot/', response_model=Response)
        ...
        @app.get(
            '/open-rmf/fyp_fm/action_paths/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/fyp_fm/start_activity/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/fyp_fm/toggle_teleop/', response_model=Response
        )
